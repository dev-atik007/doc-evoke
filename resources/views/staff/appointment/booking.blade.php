                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span class="fw-bold">@php
                            echo $doctor->statusBadge($doctor->status)
                        @endphp</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Feature
                        ...
                        @if($doctor->featured == 1)
                            <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn" data-action="" data-question="Are you sure to NonFeature this doctor?">
                                <i class="la la-eye-slash"></i>NonFeature
                            </button>
                        @else
                            <button type="button" class="btn btn-sm btn-outline--success ms-1 confirmationBtn" data-action="" data-question="Are you sure to featured this doctor?">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Fees
                        <span class="fw-bold">{{ $doctor->fees }}USD</span>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="row p-3 bg--white">
                        ...
                        <div class="form-group">
                            <label class="form-label">Mobile
                                <i class="fa fa-info-circle text--primary" title="Add the country code by general setting. Otherwise, SMS won\'t send to that number.">
                                </i>
                            </label>
                            <div class="input-group">
