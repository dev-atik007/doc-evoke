...
<html
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">{{ $general->site_name }}</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboards -->
              @include('doctor.partisals.sidenav')
          </ul>
        </aside>
        <div class="layout-page">
          <!-- Navbar -->

            @include('doctor.partisals.topnav')
          ...
          <div class="content-wrapper">
            ...
            <footer class="content-footer footer bg-footer-theme">
                @include('doctor.partisals.footer')
            </footer>
            <!-- / Footer -->
  ...
  <script src="{{ asset('public/admin/assets/js/nicEdit.js') }}"></script>
  <script src="{{ asset('public/admin/assets/vendor/js/select2.min.js') }}"></script>
